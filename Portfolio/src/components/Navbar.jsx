...
const Navbar = () => {
  ...
  const navLinks = [
    { id: 1, text: "Home", href: "#",test:false },
    { id: 2, text: "About", href: "#About", test:false },
    { id: 3, text: "Project", href: "#Projet" , test:false},
    { id: 4, text: "Skills", href: "#Skills" , test:false},
    { id: 5, text: "Contact", href: "#Contact" , test:false},
  ];
