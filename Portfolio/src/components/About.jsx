...
const About = () => {
  return (
    <section id="About" className=" px-6 h-screen">
      {/* Titre */}
      ...
      {/* Contenu principal */}
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between gap-10 pt-14">
        {/* Image */}
        <figure className="w-[300px] h-[300px] lg:w-[350px] lg:h-[350px] flex-shrink-0">
          <img
            src={img}
            alt="Profil"
            className="ml-44 rounded-full bg-slate-200 shadow-[1px_1px_60px_0px_#218873]"
          />
        </figure>
