...
const Hero = () => {
  return (
    <section className="container mx-auto flex flex-col lg:flex-row justify-between items-center min-h-screen py-10 px-4 sm:px-8 lg:px-16">
      {/* Content Section */}
      ...
      <div  className="mt-12 lg:mt-0 w-full max-w-2xl flex justify-center">
        <DotLottieReact 
